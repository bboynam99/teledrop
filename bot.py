...
Do no forget to join our Telegram Group
{TELEGRAM_LINKS}
"""
...
JOINED = f"""
Thank you!
Rewards would be avalaible to claim on {AIRDROP_NETWORK} address on the {AIRDROP_DATE}
...
WITHDRAWAL_TEXT = f"""
Withdrawals would be avalaible to claim on {AIRDROP_NETWORK} address on the {AIRDROP_DATE}
NOTE: Users found Cheating would be disqualified & banned immediately."""
